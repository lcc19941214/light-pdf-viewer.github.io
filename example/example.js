...
var _lightPdfViewer = __webpack_require__(4);

var _lightPdfViewer2 = _interopRequireDefault(_lightPdfViewer);
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (file && /^application\/pdf$/.test(file.type)) {
        ...
        reader.addEventListener('load', function () {
          _this.setState({ URI: reader.result });
        }, false);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'https://github.com/lcc19941214/light-pdf-viewer', target: '_blank' },
              'Conan Lau'
            )
          )
        ),
        _react2.default.createElement(
          ...
          'upload any pdf if you want\xA0\xA0',
          _react2.default.createElement('input', { type: 'file', accept: 'application/pdf', onChange: this.handleInputChange })
        ),
        _react2.default.createElement(_lightPdfViewer2.default, { URI: this.state.URI })
      );
    }
  }]);
...
var _Promise2 = typeof Promise === 'undefined' ? __webpack_require__(6).Promise : Promise;

(function webpackUniversalModuleDefinition(root, factory) {
  if (( false ? 'undefined' : _typeof2(exports)) === 'object' && ( false ? 'undefined' : _typeof2(module)) === 'object') module.exports = factory(__webpack_require__(1), __webpack_require__(2), __webpack_require__(0), __webpack_require__(0));else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), __webpack_require__(0), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else if ((typeof exports === 'undefined' ? 'undefined' : _typeof2(exports)) === 'object') exports["light-pdf"] = factory(require("react"), require("react-dom"), require("pdfjs-dist/web/pdf_viewer"), require("pdfjs-dist/build/pdf"));else root["light-pdf"] = factory(root["React"], root["ReactDOM"], root["PDFJS"], root["PDFJS"]);
})(undefined, function (__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_16__) {
  return (/******/function (modules) {
      ...
      var PDFViewer = function (_Component) {
        ...
        _createClass(PDFViewer, [{
          ...
          value: function render() {
            ...
            return URI ? _react2.default.createElement('div', { className: 'PDFViewer' }, toolbar && _react2.default.createElement(_toolbar2.default, { URI: URI, options: options }), _react2.default.createElement(_viewer2.default, this.props)) : null;
          }
        }]);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      var _Promise = typeof _Promise2 === 'undefined' ? __webpack_require__(17).Promise : _Promise2;
      ...
      var Viewer = function (_Component) {
        ...
        _createClass(Viewer, [{
          ...
          value: function render() {
            ...
            return _react2.default.createElement('div', { className: 'pdf-viewer-wrapper' }, _react2.default.createElement('div', { className: 'pdfViewer pdf-viewer' }), _react2.default.createElement(_toolbox2.default, {
              URI: URI,
              toolbox: toolbox,
              scale: scale,
              pageCount: pageCount,
      ...
      var Toolbox = function (_Component) {
        ...
        function Toolbox() {
          ...
          return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbox.__proto__ || Object.getPrototypeOf(Toolbox)).call.apply(_ref, [this].concat(args))), _this), _this.toolboxNames = ['pager', 'zoomer', 'operation'], _this.toolboxItems = function (props) {
            ...
            return {
              pager: _react2.default.createElement('div', { className: 'toolbox__item page-group', key: 'toolbox-pager' }, _react2.default.createElement('div', { className: 'label' }, '\u9875\u9762'), _react2.default.createElement('div', { className: 'current' }, currentPage), _react2.default.createElement('span', { className: 'divide-line' }, '/'), _react2.default.createElement('div', { className: 'count' }, pageCount)),
              zoomer: _react2.default.createElement('div', { className: 'toolbox__item action-group', key: 'toolbox-zoomer' }, _react2.default.createElement('div', {
                className: (0, _classnames2.default)('action-btn', {
                  disabled: scale <= _constant.MIN_SCALE
                }),
                onClick: _this.props.handleZoomOut }, _react2.default.createElement('div', { className: 'action-btn__icon zoom-out' })), _react2.default.createElement('div', { className: 'action-btn', onClick: _this.props.handleZoomToggle }, _react2.default.createElement('div', {
                ...
                onClick: _this.props.handleZoomIn }, _react2.default.createElement('div', { className: 'action-btn__icon zoom-in' }))),
              operation: _react2.default.createElement('div', { className: 'toolbox__item action-group', key: 'toolbox-operation' }, _react2.default.createElement('a', {
                className: 'action-btn',
                download: true,
                href: URI,
                onClick: _this.props.handleDownload }, _react2.default.createElement('div', { className: 'action-btn__icon download', href: URI, download: true })))
            };
          }, _temp), _possibleConstructorReturn(_this, _ret);
        }
        ...
        _createClass(Toolbox, [{
          ...
          value: function render() {
            ...
            return content.length && pageCount ? _react2.default.createElement('div', { className: 'toolbox-wrapper' }, _react2.default.createElement('div', { className: 'toolbox' }, content)) : null;
          }
        }]);
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      var ToolBar = function (_Component) {
        ...
        _createClass(ToolBar, [{
          key: 'render',
          value: function render() {
            return _react2.default.createElement('div', { className: 'toolbar-wrapper' }, _react2.default.createElement('div', { className: 'toolbar' }, _react2.default.createElement('div', { className: 'action-group' }, _react2.default.createElement('div', { className: 'action-btn' }, '+'), _react2.default.createElement('div', { className: 'action-btn' }, '-'))));
          }
        }]);
